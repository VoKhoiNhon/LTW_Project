...
public class OrderService {
    ...
    public void addToOrder(String idOrder, String phone, String address, String timOrder, String timePickup, String note, int condition) {
        JDBIConnector.get().withHandle(handle -> {
            return handle.createUpdate("INSERT INTO orders VALUES('"+idOrder+"','"+phone+"','"+address+"','"+timOrder+"','"+timePickup+"','"+note+"',"+condition+")" ).execute();
        });
    }
