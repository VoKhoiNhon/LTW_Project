...
public class ViewContact extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<div class=\"edit_formUser\">\n" +
                ...
                "                                <h4 class=\"padding10px\">Thông tin khách hàng phản hồi</h4>\n" +
                ...
                "                                <label>ID</label>\n" +
                "                                <input type=\"text\" value=\""+idcontact+"\" name=\"idcontact\" class=\"form-control input_addpr\"\n" +
                "                                    placeholder=\"\">\n" +
                "                            </div>\n" +
                "                            <div class=\"form-group\">\n" +
                ...
                "                            <input onclick=\"huy()\" type=\"submit\" value=\"Đóng\">\n" +
                "                       \n" +
                "                        </div>\n" +
                "                    </div>\n" +
                "                </form>\n" +
