                    ...
                    <div class="card" style=" margin:auto;">
                        <div class="card-body">
                            <p class="card-description">
                                <a href="/BHNFoods/index" style="text-decoration: none ; color: rgb(112, 112, 112);"> <i
                            ...
                            <form class="forms-sample" action="/BHNFoods/Login" method="post">
                                ...
                                <div class="login_social">
                                    <a href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile&redirect_uri=http://localhost:8080/BHNFoods/LoginGG&response_type=code
		&client_id=209315281506-9itod9oiojmbqe56ri7567e6nqi2e181.apps.googleusercontent.com&approval_prompt=force">Login
                                        Google</a>
                                    <a href="https://www.facebook.com/dialog/oauth?client_id=761456919098163&redirect_uri=http://localhost:8080/BHNFoods/LoginFacebook&scope="
                                       +<%=StringUtils.join(permissions)%>>Login Facebook</a>
                                    <%--                                    <a href="https://www.facebook.com/vX.X/dialog/oauth?client_id=761456919098163&redirect_uri=http://localhost:8080/BHNFoods/LoginFacebook&scope="></a>--%>
